    ...
    <ThreadListItemMorePrimitive.Root>
      ...
      >
        ...
        <ThreadListItemPrimitive.Delete asChild>
          <ThreadListItemMorePrimitive.Item className="aui-thread-list-item-more-item flex cursor-pointer select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm text-red-500 outline-none hover:bg-red-500/10 hover:text-red-500 focus:bg-red-500/10 focus:text-red-500 dark:text-red-900 dark:hover:bg-red-900/10 dark:hover:text-red-900 dark:focus:bg-red-900/10 dark:focus:text-red-900">
